...
const (
	// TODO: do we need a new controller agent name?
	ControllerAgentName = "kafka-trigger-controller"

	// TODO: do we need a new finalizer?
...
func NewController(ctx context.Context, watcher configmap.Watcher, configs *config.Env) *controller.Impl {
	...
	brokerInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: kafka.BrokerClassFilterYolo(),
	...
	configmapInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		// TODO: filter configmaps by label/name for all namespaces as we don't know the broker/trigger namespace at this stage
...
// TODO: rename to enqueueTriggersByBrokers
